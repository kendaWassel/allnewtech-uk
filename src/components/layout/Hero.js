const Hero = ({title,subtitle}) => {
  return (
    <section className="relative h-[300px] sm:h-[200px] md:h-[315px] lg:h-[calc(315px_+_85px)] lg:top-[-85px] top-0 w-full bg-linear-[90deg] from-[var(--primary-blue-second)] to-[var(--secondary)]">
